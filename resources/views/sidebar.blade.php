...
<div class="d-flex flex-column flex-shrink-0 p-3 sidebar">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
        ...
        <span class="fw-bold text-white"><h3>Bisto App</h3></span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="{{ url('resto/list') }}" class="nav-link link-body-emphasis @yield('resto') text-white">
        ...
        <li>
            <a href="{{ url('category/list') }}" class="nav-link link-body-emphasis @yield('category') text-white">
        ...
        <li>
            <a href="{{ url('province/list') }}" class="nav-link link-body-emphasis @yield('province') text-white">
        ...
        <li>
            <a href="{{ url('city/list') }}" class="nav-link link-body-emphasis @yield('city') text-white">
        ...
        <li>
            <a href="{{ url('user/list') }}" class="nav-link link-body-emphasis @yield('user') text-white">
        ...
        <li>
            <a href="{{ url('admin/list') }}" class="nav-link link-body-emphasis @yield('admin') text-white">
    ...
    <div class="dropdown">
        ...
        @endif
        <strong class="ms-3 text-white">{{ session('name') }}</strong>
        </a>
